...
*& Descriptions  :
** 修改日期   开发人员  请求号        描述
" 20170629   IT02     ED1K905936    产成品入库单
*&
*&---------------------------------------------------------------------*
...
*&--代码注释 BY HANDYBY 07.07.2017 15:45:03  BEGIN
*    DATA:L_FORMNAME TYPE TDSFNAME  VALUE 'ZSFQM004'.
*&--代码注释 BY HANDYBY 07.07.2017 15:45:03  END
...
PARAMETERS    : P_WERKS TYPE AUFK-WERKS DEFAULT '1700' OBLIGATORY.
SELECT-OPTIONS:
...
*    FROM AFPO.
*
*    SORT GT_DATA1 BY LGORT.
*    DELETE ADJACENT DUPLICATES FROM GT_DATA1 COMPARING LGORT.
*-0---------------------------------------------
...
FORM FRM_INIT_LVC .
  ...
  INIT_FIELDCAT 'LGORT'            '库存地点'        '' '' '' 'X' '' 'T001L' 'LGORT'.
