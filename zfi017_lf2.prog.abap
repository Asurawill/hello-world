...
*&--代码添加 BY HANDYBY 21.08.2017 16:43:28  BEGIN
                S_EKGRP FOR EKKO-EKGRP ,                                      " 采购组
                S_BUDAT FOR ZFI017-BUDAT .                                    " 记账日期
*&--代码添加 BY HANDYBY 21.08.2017 16:43:28  END
...
*&--代码添加 BY HANDYBY 21.08.2017 16:47:05  BEGIN
  AND EKGRP IN S_EKGRP
  AND BUDAT IN S_BUDAT .
*&--代码添加 BY HANDYBY 21.08.2017 16:47:05  END
...
*             _COLLECT       = ' '
          ...
          GS_DATA-ZNAME1 = SY-UNAME. "审批人
*&--代码添加 BY HANDYBY 21.08.2017 17:22:52  BEGIN
          CLEAR GS_DATA-BUDAT .
*&--代码添加 BY HANDYBY 21.08.2017 17:22:52  END
          MODIFY GT_DATA FROM GS_DATA.
          MOVE-CORRESPONDING GS_DATA TO GS_ZFI017_1.
          APPEND GS_ZFI017_1 TO GT_ZFI017_1.
          CLEAR GS_DATA.
...
*&--代码添加 BY HANDYBY 21.08.2017 17:23:25  BEGIN
        GS_DATA-BUDAT = WA_DOCUMENTHEADER-PSTNG_DATE .
*&--代码添加 BY HANDYBY 21.08.2017 17:23:25  END
        MODIFY  GT_DATA FROM GS_DATA.
        CLEAR GS_DATA.
      ENDLOOP.
    ENDLOOP.
...
*更新自建表状态
    ...
    MESSAGE S312(F5) WITH  GS_HEAD-BELNR '1700'.
    CLEAR GS_HEAD.
    CLEAR GS_ITEM.
    REFRESH GT_ITEM.
