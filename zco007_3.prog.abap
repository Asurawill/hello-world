...
FORM FRM_INIT_LVC .
  ...
  INIT_FIELDCAT 'BELNR'          'RV凭证号'               '' '' '' '' 'X' '' ''.
  INIT_FIELDCAT 'BUZEI'          'RV凭证行项目'           '' '' '' '' '' '' ''.
  INIT_FIELDCAT 'EBELN'          '采购订单号'             '' '' '' '' '' '' ''.
  INIT_FIELDCAT 'EBELP'          '采购订单行号'             '' '' '' '' '' '' ''.
  INIT_FIELDCAT 'VBUND'          '收货公司'             '' '' '' '' '' '' ''.
  INIT_FIELDCAT 'XBLNR'          '开票凭照号'             '' '' '' '' '' '' ''.
...
* Date
  WA_HEADER-TYP  = 'S'.
  WA_HEADER-KEY = '报表日期: '.
  CONCATENATE  S_BUDAT-LOW+0(4) '年'
               S_BUDAT-LOW+4(2) '月' INTO WA_HEADER-INFO.   "todays date
  APPEND WA_HEADER TO T_HEADER.
  CLEAR: WA_HEADER.
