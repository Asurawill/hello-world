...
IF GT_DATA[] IS NOT INITIAL.
  ...
  SELECT * INTO CORRESPONDING FIELDS OF TABLE GT_SKAT FROM SKAT WHERE KTOPL = '1000' AND SAKNR  BETWEEN '6001000000' AND '6001999999'.
...
FORM FRM_DEAL_DATA .
  ...
  LOOP AT GT_DATA ASSIGNING <FS_DATA> .
    ...
    ENDIF.
    IF <FS_DATA>-YWLX NE  '公司间' AND <FS_DATA>-YWLX NE  '产品' AND <FS_DATA>-YWLX NE  '项目' .
      <FS_DATA>-YWLX = '其他'.
      "客户
      <FS_DATA>-KUNNR = <FS_DATA>-VBUND.
       "加上前导零函数
