...
* 将数据放进内保
    LOOP AT LT_MARA INTO LS_MARA .
      ...
      LS_ZMMT001-MATNR = LS_MARA-MATNR ."物料号
      LS_ZMMT001-LVORM = LS_MARA-LVORM ."删除标识
      LS_ZMMT001-EXTWG = LS_MARA-EXTWG ."品牌
      LS_ZMMT001-MEINS = LS_MARA-MEINS ."单位
      LS_ZMMT001-MATKL = LS_MARA-MATKL ."物料组
      LS_ZMMT001-BISMT = LS_MARA-BISMT ."旧物料号
      " 日期格式转换
      CONCATENATE LS_MARA-ERSDA+0(4) '-' LS_MARA-ERSDA+4(2) '-' LS_MARA-ERSDA+6(2) INTO LS_ZMMT001-ERSDA ."创建日期
*      LS_ZMMT001-ERSDA = LS_MARA-ERSDA .
      CONCATENATE LS_MARA-LAEDA+0(4) '-' LS_MARA-LAEDA+4(2) '-' LS_MARA-LAEDA+6(2) INTO LS_ZMMT001-LAEDA ."更新日期
