...
SELECT A~BUKRS A~GJAHR A~BELNR A~BLART A~BUDAT A~WAERS AS WAERS_1 A~BKTXT A~XBLNR A~AWTYP
  ...
  WHERE A~BUKRS = P_BUKRS AND BUDAT IN S_BUDAT AND ( A~BLART = 'WL' OR A~BLART = 'WA' ) AND (  ( B~HKONT  BETWEEN '6404000000' AND '6404999999' ) OR B~HKONT = '1406010101' ) .
...
IF GT_DATA[] IS NOT INITIAL.
  ...
  SELECT * INTO CORRESPONDING FIELDS OF TABLE GT_SKAT FROM SKAT WHERE KTOPL = '1000' AND (  ( SAKNR  BETWEEN '6404000000' AND '6404999999' ) OR SAKNR = '1406010101' ) .
...
FORM FRM_DEAL_DATA .
  ...
  LOOP AT GT_DATA ASSIGNING <FS_DATA> .
    ...
    IF SY-SUBRC = 0.
     ...
     ENDIF.
    IF <FS_DATA>-HKONT EQ '1406010101'.
       "先判断是否为产品订单
