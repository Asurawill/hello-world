...
RANGES:P3_HKONT FOR BSEG-HKONT.
...
IF I_HKONT[] IS NOT INITIAL.
  ...
  WHERE BUKRS = t_belen-BUKRS AND GJAHR = t_belen-gjahr AND belnr =   t_belen-belnr and  blart not  in ('SA','QC') AND MONAT IN  P_MONAT AND KOSTL IN P_KOSTL AND KUNNR IN P_KUNNR AND LIFNR_2 IN P_LIFNR AND AUFNR IN P_AUFNR AND VBEL2_2 IN P_VBEL AND
   HKONT IN P1_HKONT  and  blart not  in ('SA','QC') .
  endif.
  SELECT *  APPENDING CORRESPONDING FIELDS OF TABLE T_ITEM
  FROM ZFIRFC01
...
IF P1_HKONT[] IS INITIAL AND P2_HKONT[] IS INITIAL.
  ...
  WHERE BUKRS IN P_BUKRS AND GJAHR IN P_GJAHR AND MONAT IN  P_MONAT AND KOSTL IN P_KOSTL AND KUNNR IN P_KUNNR AND LIFNR_2 IN P_LIFNR AND AUFNR IN P_AUFNR AND VBEL2_2 IN P_VBEL
       AND  HKONT in  P3_hkont and   blart in ('SA','QC').
ENDIF.
...
*  AND VBEL2 IN I_VBEL.
SORT T_ITEM BY BUKRS GJAHR MONAT BELNR BUZEI KOSTL KUNNR LIFNR AUFNR VBEL2 HKONT SHKZG.
DELETE ADJACENT DUPLICATES FROM T_ITEM COMPARING BUKRS GJAHR MONAT BELNR BUZEI KOSTL KUNNR LIFNR AUFNR VBEL2 HKONT SHKZG.
LOOP AT T_ITEM.
