...
SELECT A~BUKRS A~GJAHR A~BELNR A~BLART A~BUDAT A~WAERS AS WAERS_1 A~BKTXT A~XBLNR A~AWTYP
     B~BUZEI B~SHKZG B~DMBTR B~WRBTR B~XNEGP B~HKONT B~ZUONR B~EBELN B~MATNR B~VBEL2 B~KUNNR
...
IF GT_DATA[] IS NOT INITIAL.
  ...
  WHERE BUKRS = P_BUKRS AND GJAHR = GT_DATA-GJAHR AND BELNR = GT_DATA-BELNR AND HKONT IN R2_HKONT.
...
FORM FRM_DEAL_DATA .
  ...
  LOOP AT GT_DATA ASSIGNING <FS_DATA> .
   ...
   "类型 为收款
             ...
             IF <FS_DATA>-BLART = 'QC'.
               <FS_DATA>-YWLX = '期初'.
                ...
                "项目名称
                  ...
                  CONTINUE.
              ENDIF.
             READ TABLE GT_BSEG WITH KEY BUKRS = <FS_DATA>-BUKRS GJAHR = <FS_DATA>-GJAHR BELNR = <FS_DATA>-BELNR BINARY SEARCH.
              IF SY-SUBRC NE  0.
                IF <FS_DATA>-BLART = 'SA' OR  <FS_DATA>-BLART = 'ZA'  .
                  <FS_DATA>-YWLX = '收款'.
                  <FS_DATA>-VBELN = <FS_DATA>-ZUONR.
                "项目名称
                  PERFORM SELXMMC USING <FS_DATA>-VBELN CHANGING <FS_DATA>-XMMC.
      ...
      ENDIF.
    "其他
     IF <FS_DATA>-YWLX NE '收款' AND <FS_DATA>-YWLX NE '开票' AND  <FS_DATA>-YWLX NE '期初' .
       <FS_DATA>-YWLX = '其他'.
     ENDIF.
