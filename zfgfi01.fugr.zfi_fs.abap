...
IF P1_HKONT[] IS INITIAL AND P2_HKONT[] IS INITIAL.
      SELECT *  INTO CORRESPONDING FIELDS OF TABLE T_ITEM
  FROM ZFI011
  WHERE BUKRS IN P_BUKRS AND GJAHR IN P_GJAHR AND MONAT IN  P_MONAT AND KOSTL IN P_KOSTL AND KUNNR IN P_KUNNR AND LIFNR IN P_LIFNR AND AUFNR IN P_AUFNR AND VBEL2 IN P_VBEL .
ENDIF.
