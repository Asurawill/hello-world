...
TYPES:BEGIN OF TY_DATA,
        ...
        ZTERM     TYPE   ZFI017-ZTERM,   "付款条件
        TEXT1     TYPE   ZFI017-TEXT1,   "付款条件描述
...
SELECT-OPTIONS: S_BUKRS   FOR EKKO-BUKRS NO INTERVALS NO-EXTENSION OBLIGATORY DEFAULT '1700' ,"会计年度
...
*   AND   ZCLJD    IN S_ZCLJD
   ...
   AND   POSID    IN S_WBS
   AND   ZCLJD    = '1'
*&--代码添加 BY HANDYBY 21.08.2017 17:46:08  BEGIN
   AND EKGRP IN S_EKGRP .
*&--代码添加 BY HANDYBY 21.08.2017 17:46:08  END
  ...
  IF GT_ZFI017[] IS NOT INITIAL.
    ...
    WHERE  A~LIFNR IN S_LIFNR
      AND A~EKORG = S_BUKRS-LOW
      AND LIFNR = GT_ZFI017-LIFNR .
*&--代码注释 BY HANDYBY 24.08.2017 17:34:36  BEGIN
*    AND  A~EKGRP IN S_EKGRP.
*&--代码注释 BY HANDYBY 24.08.2017 17:34:36  END
...
FORM FRM_DEAL_DATA .
  ...
  LOOP AT  GT_ZFI017 INTO GS_ZFI017.
    ...
    IF SY-SUBRC = 0.
*&--代码注释 BY HANDYBY 24.08.2017 17:35:25  BEGIN
*       GS_DATA-EKGRP = T_LFM1-EKGRP. "
*&--代码注释 BY HANDYBY 24.08.2017 17:35:25  END
