...
*   AND   GJAHR    IN S_GJAHR
   ...
   AND   ZSQD     IN S_ZSQD
   AND   POSID    IN S_WBS
*&--代码添加 BY HANDYBY 21.08.2017 17:28:38  BEGIN
   AND EKGRP IN S_EKGRP
   AND BUDAT IN S_BUDAT .
*&--代码添加 BY HANDYBY 21.08.2017 17:28:38  END
...
*   AND   ZUONR = GT_ZFI017-ZSQD
    ...
    SELECT A~LIFNR A~EKORG A~EKGRP  B~EKNAM
     ...
     WHERE A~LIFNR IN S_LIFNR
       AND  A~EKORG = GT_ZFI017-BUKRS
       AND LIFNR = GT_ZFI017-LIFNR .
*&--代码注释 BY HANDYBY 24.08.2017 17:33:28  BEGIN
*    AND  A~EKGRP IN S_EKGRP.
*&--代码注释 BY HANDYBY 24.08.2017 17:33:28  END
...
FORM FRM_DEAL_DATA .
  ...
  LOOP AT  GT_ZFI017 INTO GS_ZFI017.
    ...
    IF SY-SUBRC = 0.
*&--代码注释 BY HANDYBY 24.08.2017 17:36:20  BEGIN
*       GS_DATA-EKGRP = T_LFM1-EKGRP. "
*&--代码注释 BY HANDYBY 24.08.2017 17:36:20  END
...
*              GS_DATA-JDYFJE = GS_DATA-JDYFJE + LS_ZFI017-ZSQFKJE .
*            ENDIF.
*            IF LS_ZFI017-STATU NE '@0A@' AND LS_ZFI017-FKJD = '2' .
*              GS_DATA-JDYSQJE = GS_DATA-JDYSQJE + LS_ZFI017-ZSQFKJE .
*            ENDIF.
*            CLEAR LS_ZFI017 .
*          ELSE .
...
*              GS_DATA-JDYFJE = GS_DATA-JDYFJE + LS_ZFI017-ZSQFKJE .
*            ENDIF.
*            IF LS_ZFI017-STATU NE '@0A@' AND LS_ZFI017-FKJD = '3' .
*              GS_DATA-JDYSQJE = GS_DATA-JDYSQJE + LS_ZFI017-ZSQFKJE .
*            ENDIF.
*            CLEAR LS_ZFI017 .
*          ELSE .
...
FORM FRM_PRINT .
  ...
  DATA:L_FORMNAME TYPE TDSFNAME ."VALUE 'ZSFFI017_3'.
  DATA:L_PAGE  TYPE I.
...
*&--代码注释 BY HANDYBY 21.08.2017 17:34:27  BEGIN
*
*  ELSE.
*    LOOP AT GT_DATA INTO GS_DATA WHERE ZBOX = 'X'.
*
...
*  ENDIF.
*
*&--代码注释 BY HANDYBY 21.08.2017 17:34:27  END
