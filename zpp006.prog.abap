...
FORM DATA_RETRIVEL .
  ...
  SELECT AUFK~AUART
    ...
    AND MSEG~RSNUM = ''
    AND MSEG~BWART IN ('Z05','Z06','531','532')
     .
...
FORM BUILD_FIELDCATALOG .
  ...
  PERFORM FRM_FILL_CAT USING :
                 ...
                 12 ''  'CHARG'  'ZPP005_STRU'    TEXT-012   , "批次
...
FORM FRM_FILL_CAT USING U_POS U_EDIT U_FNAME U_TABNAME U_NAME.
  ...
  ENDIF.
  IF U_FNAME = 'BAKMG' OR U_FNAME = 'ERFMG'.
...
*&--代码添加 BY HANDYBY 10.07.2017 17:54:07  BEGIN
  IF P_WERKS = '1610' .
    L_FORMNAME = 'ZSFPP005_1'.
  ENDIF.
*&--代码添加 BY HANDYBY 10.07.2017 17:54:07  END
