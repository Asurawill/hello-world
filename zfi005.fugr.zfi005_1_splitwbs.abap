...
*"     VALUE(PS_POSID1) LIKE  BDCDATA-FVAL OPTIONAL
...
CLEAR T_ITEM_SPLIT1[].
IMPORT T_ITEM_SPLIT1[] FROM MEMORY ID 'ZFI005_1_ITEMWBS'.
...
ENDIF.
  ...
  ENDIF.
*  IF T_ITEM_SPLIT1-PS_POSID2 IS NOT INITIAL .
*   perform bdc_dynpro      using 'SAPLKACB' '0002'."Line 1 subscreen <-
*
*   perform bdc_field       using 'BDC_CURSOR'
*                              'COBL-PS_POSID'.
...
FREE MEMORY ID 'ZFI005_1_ITEMWBS'.
