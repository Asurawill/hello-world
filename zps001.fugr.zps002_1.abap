...
* 创建WBS元素
    ...
    CONCATENATE '项目费用-' I_POST1 INTO LT_WBS-DESCRIPTION .
    LT_WBS-WBS_BILLING_ELEMENT = 'X' .
    APPEND LT_WBS .
    CLEAR LT_WBS .
    "A 层
    CONCATENATE I_PSPID 'A' INTO LT_WBS-WBS_ELEMENT .
    CONCATENATE '产品销售-' I_POST1 INTO LT_WBS-DESCRIPTION .
    LT_WBS-WBS_BILLING_ELEMENT = 'X' .
    LT_WBS-WBS_UP = I_PSPID .
    APPEND LT_WBS .
    CLEAR LT_WBS .
    "B 层
    CONCATENATE I_PSPID 'B' INTO LT_WBS-WBS_ELEMENT .
    CONCATENATE '工程制作-' I_POST1 INTO LT_WBS-DESCRIPTION .
    LT_WBS-WBS_BILLING_ELEMENT = 'X' .
    LT_WBS-WBS_UP = I_PSPID .
    APPEND LT_WBS .
    CLEAR LT_WBS .
    "C 层
    CONCATENATE I_PSPID 'C' INTO LT_WBS-WBS_ELEMENT .
    CONCATENATE '创意服务-' I_POST1 INTO LT_WBS-DESCRIPTION .
    LT_WBS-WBS_BILLING_ELEMENT = 'X' .
    LT_WBS-WBS_UP = I_PSPID .
    APPEND LT_WBS .
    CLEAR LT_WBS .
    "D 层
    CONCATENATE I_PSPID 'D' INTO LT_WBS-WBS_ELEMENT .
    CONCATENATE '运营维保-' I_POST1 INTO LT_WBS-DESCRIPTION .
    LT_WBS-WBS_BILLING_ELEMENT = 'X' .
    LT_WBS-WBS_UP = I_PSPID .
    APPEND LT_WBS .
    CLEAR LT_WBS .
...
* 网络表头创建
    ...
    DATA: BEGIN OF LS_NETWORK2 ,
            NETWORK TYPE NW_AUFNR,
          END OF LS_NETWORK2 .
    DATA LT_NETWORK2 LIKE TABLE OF LS_NETWORK2 .
    ...
    DELETE LT_WBS[] WHERE WBS_ELEMENT = I_PSPID . "去掉首层WBS
    LOOP AT LT_WBS.
      LS_NETWORK-WBS_ELEMENT = LT_WBS-WBS_ELEMENT .
        ...
        ELSEIF SY-SUBRC <> 0 .
          ...
          ELSEIF SY-SUBRC <> 0 .
            ...
            ELSEIF SY-SUBRC <> 0 .
              ...
              LS_NETWORK2-NETWORK = LT_RETURN3_2-MESSAGE_V2 .
              APPEND LS_NETWORK2 TO LT_NETWORK2 .
              CLEAR LS_NETWORK2 .
            ENDIF.
          ENDIF.
        ENDIF.
      ...
      CLEAR: LT_RETURN4,LT_RETURN3_2 .
      REFRESH: LT_RETURN4[],LT_RETURN3_2[] .
      CLEAR LS_NETWORK-WBS_ELEMENT .
    ENDLOOP.
...
* 网络作业创建
    ...
    LOOP AT LT_NETWORK2 INTO LS_NETWORK2 .
      LT_METHOD-REFNUMBER = 000001 .
      LT_METHOD-OBJECTTYPE = 'NETWORK-ACTIVITY' .
      LT_METHOD-METHOD = 'Create' .
      CONCATENATE LS_NETWORK2-NETWORK '0010' INTO LT_METHOD-OBJECTKEY .
      APPEND LT_METHOD .
      CLEAR LT_METHOD .
      ...
      LT_ACTIV-NETWORK = LS_NETWORK2-NETWORK .
      ...
      CLEAR: LS_RETURN2,E_MSG2 .
      REFRESH: LT_METHOD[],LT_ACTIV[],LT_ACTIVX[],E_MSG2[] .
      CLEAR LS_NETWORK2 .
...
* 写入调用日志
  ...
  LS_ZZACKNOW-ZZKEYF1  = 'ZPS002_1' .   "函数模块名
  IF E_RETURN-TYPE = 'E'.
